      ...
      <div class="tsx-demo p-6 bg-white rounded-lg shadow-md">
        ...
        <section class="mb-6">
          ...
          <div class="bg-gray-50 p-4 rounded">
            <p class="text-gray-600 mb-2">消息: <span class="font-medium">{message.value}</span></p>
            <p class="text-gray-600">计数: <span class="font-medium text-blue-600">{count.value}</span></p>
            <p class="text-gray-600">双倍计数: <span class="font-medium text-green-600">{doubleCount.value}</span></p>
          </div>
        </section>
        ...
        <section class="mb-6">
          ...
          <div class="bg-gray-50 p-4 rounded">
            {count.value > 0 ? (
              <p class="text-green-600 font-medium">计数为正数: {count.value}</p>
            ) : count.value < 0 ? (
